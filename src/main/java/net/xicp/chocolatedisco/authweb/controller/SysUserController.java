package net.xicp.chocolatedisco.authweb.controller;

import net.xicp.chocolatedisco.authweb.entity.SysUser;
import net.xicp.chocolatedisco.authweb.exception.DuplicateInformationException;
import net.xicp.chocolatedisco.authweb.repository.SysUserRepository;
...
public class SysUserController extends BaseController {
    ...
    @GetMapping("/sysUsers/findByAccount")
    public SysUser findByAccount(@RequestParam(name = "account") String account) {
